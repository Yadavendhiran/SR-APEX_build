...
folder_1080_path=r"D:\yt\collegeProj\dataset video\val\val_sharp"
folder_480_path=r"D:\yt\collegeProj\dataset video\val\val_sharp_bicubic\X4"
...
model.load_state_dict(
    torch.load("SRCNN_4X_v0.3.pth",map_location="cuda")
)
crierion=nn.MSELoss()
...
for i in range(epchos):
    ...
    print("Epcho:",i+1,"average epcho MSE loss:",(total_mse_loss/(6*len(dataset))),"sobel loss per epochs:",(total_sobel_loss/(6*len(dataset))))
    avg_epchho_loss.append(total_loss_epcho/(6*len(dataset)))
